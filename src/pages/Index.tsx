...
const Index = () => {
  return (
    <div className="flex flex-col items-center justify-center h-full p-8 text-center">
      <h1 className="text-4xl font-bold mb-4 text-[#3da5d9]">Welcome to Test Bot</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl w-full">
        <div className="border rounded-lg p-6 h-full hover:shadow-md transition-shadow bg-white flex flex-col items-center text-center">
          <CheckCircle size={48} className="text-[#3da5d9] mb-4" />
          ...
          <Link to="/quick-test" className="mt-auto">
            <Button className="flex items-center gap-2 bg-[#3da5d9] hover:bg-[#2d8ab8]">
        ...
        <div className="border rounded-lg p-6 h-full hover:shadow-md transition-shadow bg-white flex flex-col items-center text-center">
          <Server size={48} className="text-[#3da5d9] mb-4" />
